...
<required_reading>
@/home/niko/research/agents/kotaemon/.codex/get-shit-done/references/verification-patterns.md
@/home/niko/research/agents/kotaemon/.codex/get-shit-done/templates/verification-report.md
</required_reading>
...
```bash
node "/home/niko/research/agents/kotaemon/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${phase_number}"
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node "/home/niko/research/agents/kotaemon/.codex/get-shit-done/bin/gsd-tools.cjs" frontmatter get "$plan" --field must_haves)
...
```bash
PHASE_DATA=$(node "/home/niko/research/agents/kotaemon/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${phase_number}" --raw)
```
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node "/home/niko/research/agents/kotaemon/.codex/get-shit-done/bin/gsd-tools.cjs" verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node "/home/niko/research/agents/kotaemon/.codex/get-shit-done/bin/gsd-tools.cjs" verify key-links "$plan")
...
See /home/niko/research/agents/kotaemon/.codex/get-shit-done/templates/verification-report.md for complete template.
</step>
