...
# ---------------------------------------------------------------------------
# PaddleOCRResult adapter tests
# ---------------------------------------------------------------------------


def test_clean_table_html_strips_wrapper() -> None:
...
def test_to_documents_text_and_table() -> None:
...
@skip_when_paddleocr_not_installed
def test_ppstructure_v3_supported_file_types_attribute() -> None:
...
@skip_when_paddleocr_not_installed
def test_paddleocr_vl_supported_file_types_attribute() -> None:
    """Reader has expected supported_file_types."""
    from kotaemon.loaders import PaddleOCRVLReader
