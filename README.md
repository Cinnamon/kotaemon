...
> If you’re not a developer and just want to use the app, please check out our easy-to-follow [User Guide](https://cinnamon.github.io/kotaemon/). Download the `.zip` file from the [latest release](https://github.com/Cinnamon/kotaemon/releases/latest) to get all the newest features and bug fixes.
...
- **Non-Docker Installation**: If you’re not using Docker, install GraphRAG with the following command:
